...
INSERT INTO `productos` VALUES (1,'IphoneX','Excelente celular gama alta ultra veloz','tecnologia',4200000,'resources/img/productos/Producto(1)/',1),(2,'Apple Series 3','Marca Apple, gran relog avanzado','tecnologia',280000,'resources/img/productos/Producto(2)/',1),(3,'Refrigerador nak','Gran refrigerador, con acondicionador incluido','domesticos',455000,'resources/img/productos/Producto(3)/',1),(4,'Balon nike','Balon rojo con negro marca nike','deportes',35000,'resources/img/productos/Producto(4)/',1),(5,'Bicicleta','Bicicleta color negro, en excelente estado','deportes',180000,'resources/img/productos/Producto(5)/',2),(6,'Parlantes Genius','Parlantes negros con un muy buen sonido','tecnologia',50000,'resources/img/productos/Producto(6)/',2),(7,'Cadena Dorada','Brillante cadena de color dorado, a muy bajo precio','joyeria',10000,'resources/img/productos/Producto(7)/',2),(8,'Bicicleta Montana','Con muy buen estado, bicicleta marca montana','deportes',155000,'resources/img/productos/Producto(8)/',2),(9,'Huawei','Celular con 8G de almacenamiento, muy rapido','tecnologia',570000,'resources/img/productos/Producto(9)/',3),(10,'Pintura LaYampia','Marco de pintura, de el gran pintor Jaime Yortuno','arte',58000,'resources/img/productos/Producto(10)/',3),(11,'Impresora Cannon','Impresora marca cannon con muy buena calidad de impresión','tecnologia',185000,'resources/img/productos/Producto(11)/',3),(12,'Gorra Nike','Gorra de color negro con marca nike','deportes',25000,'resources/img/productos/Producto(12)/',3),(24,'Bicicleta Cannondale','Bicicleta Todo Terreno','Deportes',1500000,'/CVSystem/archivos/Bicicleta1.jpg',4),(25,'Anillo en Oro ','Anillo en Oro 24Kilates','tecnologia',250000,'/CVSystem/archivos/Anillo.jpg',4),(26,'Anillo en Oro ','Anillo en Oro 24Kilates','joyeria',250000,'/CVSystem/archivos/Anillo.jpg',4),(27,'Anillo en Oro ','Anillo en Oro 24Kilates','joyeria',250000,'/CVSystem/archivos/Anillo.jpg',4);
...
-- Dump completed on 2018-05-07 13:26:55
